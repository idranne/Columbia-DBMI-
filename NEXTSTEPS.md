...
---> Logo page and welcome dashboard + brief description of ParkAssist

---> Allow access to camera, microphone and keyboard

--> Build a small interface that loads to the voice recording and prop user to speak to a and collect features and the predict button goes to the backend flow
